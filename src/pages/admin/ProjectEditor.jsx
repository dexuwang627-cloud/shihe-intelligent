                ...
                {Object.entries(formData[field][lang] || {}).map(([key, value], idx) => (
                    <div key={idx} className="flex gap-2">
                        <input
                            ...
                            readOnly
                            className="w-1/3 p-2 bg-slate-200 text-slate-500 rounded border border-transparent text-sm cursor-not-allowed"
        ...
        <div className="min-h-screen pt-24 pb-12 bg-slate-50">
            ...
            <div className="container mx-auto px-4 max-w-4xl">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-slate-900">{isNew ? 'New Project' : `Edit ${formData.id}`}</h1>
                </div>
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg border border-slate-200 p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 border-b border-slate-100 pb-8">
                        <div>
                            <label className="block text-sm font-bold text-slate-700 mb-2">Project ID (URL Slug)</label>
                            <input
                                type="text"
                                required
                                disabled={!isNew}
                            ...
                            />
                            <p className="text-xs text-slate-400 mt-1">Unique identifier, used in URL. Cannot act chang after creation.</p>
                        </div>

                        <div>
                            <label className="block text-sm font-bold text-slate-700 mb-2">Display Group</label>
                            <select
                    ...
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <span className="text-sm font-bold text-slate-600">Editing Language:</span>
                    ...
                    <div className="space-y-6">
                        <div>
                            <label className="block text-sm font-bold text-slate-700 mb-2">Title ({lang.toUpperCase()})</label>
                            <input
                                type="text"
                                required
                        ...
                        <div>
                            <label className="block text-sm font-bold text-slate-700 mb-2">Category ({lang.toUpperCase()})</label>
                            <input
                                type="text"
                                required
                        ...
                        <div>
                            <label className="block text-sm font-bold text-slate-700 mb-2">Summary ({lang.toUpperCase()})</label>
                            <textarea
                                required
                                rows="3"
                        ...
                        <div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
                            <div className="flex justify-between items-center mb-4">
                                <label className="font-bold text-slate-700">Description Paragraphs ({lang.toUpperCase()})</label>
                        ...
                        <KvEditor field="specs" title="Specifications" />
                        <KvEditor field="benefits" title="Benefits" />
                    ...
                    <div className="mt-10 pt-6 border-t border-slate-100 flex justify-end gap-4">
                        ...
                        >
                            {saving ? <Loader2 className="w-5 h-5 animate-spin" /> : <><Save className="w-5 h-5" /> Save Project</>}
                        </button>
                    </div>
