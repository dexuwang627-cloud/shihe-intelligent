...
const SEO = ({ title, description, keywords, image, url }) => {
    ...
    const defaultImage = '/photos/logo1.svg';
    ...
    const fullTitle = isHome ? '世和智能' : `${String(title)} | 世和智能`;
    ...
    return (
        <Helmet>
            ...
            <meta property="og:image" content={image || 'https://www.shiheintelligent.com/photos/logo.svg'} />
